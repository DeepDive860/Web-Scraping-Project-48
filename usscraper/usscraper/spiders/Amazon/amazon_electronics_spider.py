...
class Amazon_Electronics(scrapy.Spider):

    name = "amazon_spider_electronics"
    start_urls = ["https://www.amazon.com/s?k=electronics&rh=n%3A172282&dc&ds=v1%3AQIZCghL%2FVuu0bX4SY%2Bg22K%2ButWPoFXgIvM6ENKDv0oQ&_encoding=UTF8&content-id=amzn1.sym.3fd5a3a3-34a4-4a20-93ff-d675e98f2b35&pd_rd_r=18eb3c78-0d09-4bab-a836-6aae314059f4&pd_rd_w=BUdY7&pd_rd_wg=sRbbJ&pf_rd_p=3fd5a3a3-34a4-4a20-93ff-d675e98f2b35&pf_rd_r=AHWR4YDYKS6MHKFDFS9Z&qid=1757727390&rnid=2941120011&ref=sr_nr_n_1"]
    custom_settings = {
            ...
            for res in results:
                ...
                yield scrapy.Request(
                    ...
                    meta={
                        ...
                        "playwright_context_kwargs": {"user_agent": random.choice(USER_AGENT_LIST)},
                    },
                    errback=self.errback,
                )
